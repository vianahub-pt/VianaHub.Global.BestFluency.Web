...
4. **Identidade preto / branco / laranja** como papéis cromáticos, com
...
| `--brand-orange`| `#C2410C`                          | `#C2410C`                               | Destaque, rota, ícones, detalhes          |

No tema escuro os papéis **invertem**: `brand-black` passa a ser o texto
claro e `brand-white` o fundo escuro; o laranja mantém-se como destaque.
...
| `--accent`           | `#C2410C`                | Laranja de destaque          |
| `--accent-foreground`| `hsl(0 0% 100%)`       | Texto sobre o laranja        |
| `--border`           | `hsl(0 0% 90%)`        | Bordas                       |
| `--input`            | `hsl(0 0% 90%)`        | Campos de formulário         |
| `--ring`             | `#C2410C`               | Anel de foco                 |
...
| `--accent`           | `#C2410C`                | Laranja de destaque          |
| `--accent-foreground`| `hsl(0 0% 98%)`         | Texto sobre o laranja        |
...
| `accent` (laranja) sobre `background`        | ≈ 5.2:1 | ≈ 3.8:1 |
| `accent-foreground` (texto) sobre `accent`   | ≈ 5.2:1 | ≈ 5.2:1 |
| `primary-foreground` sobre `primary`         | ≈ 17:1 | ≈ 17:1 |
| `ring` (foco) sobre `background`             | ≈ 5.2:1 | ≈ 3.8:1 |
...
| Componente           | Uso                                                        |
|----------------------|------------------------------------------------------------|
| `Button`             | Botão base (`primary` preto, `orange` laranja, `outline`, `ghost`; `default`, `lg`, `icon`). Área ≥ 44 px por omissão. |
...
| `RoutePath`          | Rota pontilhada laranja com paragens e avião (viagem subtil). |
