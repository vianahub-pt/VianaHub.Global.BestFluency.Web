...
/**
 * Foundation-Inhalte de-DE (veröffentlicht unter "/de/").
 * HINWEIS: funktionale Übersetzung, vorläufig — professionelle Prüfung vor
 * dem kommerziellen Launch ausstehend (siehe ADR 0001).
 */
