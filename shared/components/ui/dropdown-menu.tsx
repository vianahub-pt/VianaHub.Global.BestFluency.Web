...
/**
 * Dropdown menu — componente oficial shadcn/ui (new-york) sobre Radix UI
 * (issue #29). Usado pelo seletor de idiomas da landing.
 *
 * Acessibilidade (Radix): roving tabindex, navegação completa por teclado
 * (setas, Home/End, Escape), typeahead, `aria-haspopup`/`aria-expanded` no
 * trigger e foco devolvido ao trigger ao fechar. Os itens navegáveis do
 * seletor de idiomas são links reais (`DropdownMenuItem asChild` + <a>),
 * preservando a navegação por URL própria por idioma.
 */
